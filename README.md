...
4. **Night:** traitors secretly agree on someone to murder (they have a private chat if there are two or more). Item holders act. The night lasts one minute.
5. **Dawn:** you learn who died. Private results land only on the phones they belong to.
6. **Day:** argue out loud, then everyone votes. The voted-out player's side is revealed at once.
7. Innocents win by voting out every traitor. Traitors win the moment they match the number of innocents left.
...
| 6-8 | 2 | 3 plus Fake Evidence | no |
| 9-12 | 3 | 4 plus Fake Evidence | yes, one per round |
...
- 🔦 **Blackout** — the voted-out player's side stays secret.
- 🗳 **Two Voted Out** — the two most-voted players are both voted out.
...
src/
  ...
  screens/  one per phase: Home, Lobby, RoleReveal, Night, Morning, Day, Vote, Verdict, GameOver
